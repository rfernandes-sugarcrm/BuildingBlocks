...
$packageID = "BuildingBlocks_IFrameAuthDashlet";
$packageLabel = "BuildingBlocks: IFrame Auth Dashlet";
$supportedVersionRegex = '(26|25|14)\\..*$';
$acceptableSugarFlavors = array('PRO', 'ENT', 'ULT');
$description = 'Generates a token server side and passes it to the client side IFrame Dashlet for use in authenticating to a third party service.';
/******************************/
...
$installdefs = array(
        ...
        'platforms' =>
                array(
                        array(
                                'from' => '<basepath>/Extension/application/Ext/Platforms/iframe-auth-dashlet.php',
                        ),
                ),
);
